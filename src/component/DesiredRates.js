  ...
  return (
    ...
    {toggle && <>
      ...
      <div className="buttons ml-3 flex w-[20rem] justify-evenly">
        <button className="btn btn_1 bg-teal-700 p-2 w-8 text-white items-center hover:bg-teal-500 rounded-md">Submit</button>
        <button className="btn btn_1 bg-white border-2 p-2 text-teal-700 items-center hover:text-teal-900 rounded-md">Cancel</button>
       </div>
    </div>
    </>}
    </>
